...
protected[paste] enum PasteCommonConfigKeys[T](configBlockKey: PasteCommonConfigBlockKey[T]) {
  ...
  case CONTENT_DIR_SCRIPTS extends PasteCommonConfigKeys[List[String]](PasteCommonConfigBlockKey[List[String]](PasteCommonConfigBlocks.PASTE_DIRECTORY_MAP, "scripts", List("paste/scripts")))
  case CONTENT_DIR_STYLES extends PasteCommonConfigKeys[List[String]](PasteCommonConfigBlockKey[List[String]](PasteCommonConfigBlocks.PASTE_DIRECTORY_MAP, "scripts", List("paste/styles")))
  case CONTENT_DIR_IMG extends PasteCommonConfigKeys[List[String]](PasteCommonConfigBlockKey[List[String]](PasteCommonConfigBlocks.PASTE_DIRECTORY_MAP, "scripts", List("paste/images")))
