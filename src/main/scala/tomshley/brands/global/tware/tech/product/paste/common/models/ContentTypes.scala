 ...
 */
enum ContentTypes(fileExtension: String, mimeTypeValue: String) {
  case JS extends ContentTypes(".js", "text/javascript")
  case LESS extends ContentTypes(".less", "text/css")
  case CSS extends ContentTypes(".css", "text/css")
  case HTML extends ContentTypes(".html", "text/html")
  case XHTML extends ContentTypes(".xhtml", "application/xhtml+xml")
